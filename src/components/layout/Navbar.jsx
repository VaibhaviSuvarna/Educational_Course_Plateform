...
const AuthDialog = dynamic(() => import("@/components/auth/AuthDialog"), { ssr: false });
    ...
    <nav className="text-md font-semibold border-b border-gray-200 w-full relative px-4 m-0">
      <div className="flex items-center justify-between w-full p-0 m-0">
        ...
        <div className="hidden lg:flex items-center space-x-6">
          ...
          {session && (
            <Link href="/dashboard" className="transition duration-300 ease-in-out hover:font-medium hover:underline hover:underline-offset-4  text-gray-700 hover:text-blue-700 ">
              Dashboard
            </Link>
          )}
